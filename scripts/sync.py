...
SOURCES = ["michelin", "splendido", "raisin", "gambero", "blog", "rawwine", "identitagolose", "gaultmillau_at", "gaultmillau_ch", "wirtshauskultur"]
...
def run_one(name: str, **kwargs) -> tuple[str, int, int, str]:
    ...
    try:
        ...
        elif name in ("gaultmillau_at", "gaultmillau_ch", "wirtshauskultur"):
